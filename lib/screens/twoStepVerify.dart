...
class TwoStepVerify extends StatefulWidget {
  int? popupStatus = 0;
  String? email;
  TwoStepVerify({this.email, this.popupStatus});

  @override
  _TwoStepVerifyState createState() => _TwoStepVerifyState();
}
              ...
              CommonButton(title: 'Continue', onTap: (){
                ...
                if(otpTextCtrl.text.isEmpty){
                  ...
                  Provider.of<UserAuthProvider>(context, listen: false)
                      .twoStepVerify(otpTextCtrl.text, context, "false" );
                }else{
                  Provider.of<UserAuthProvider>(context, listen: false)
                      .twoStepVerify(otpTextCtrl.text, context, "true");
                }
