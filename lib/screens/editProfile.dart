...
class _PrState extends State<EditProfile> {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                      ...
                      Positioned(
                        ...
                        child: IconButton(onPressed: (){
                          ...
                          captureImageBottomSheet(context);
                            ...
                            icon: Image.asset('assets/images/ic_edit.png',width: 30,height: 30,)),
                ...
                //     captureImageBottomSheet(context);
                //   },
                //   child: Text('Edit Profile Pic', style: TextStyle(fontSize: 22,
                ...
                SizedBox(height: MediaQuery
                    ...
                    .size
                    .height * .1,),
                CommonButton(title: 'Update', onTap: () async{
                  if(sendImage == null){
                    ...
                    Provider.of<UserAuthProvider>(context, listen: false).profile(
                        context,
                        sendImage.toString(),
                        nameTextCtrl.text,
                        numberTextCtrl.text,
  ...
  setData() async{
    if(widget.userData != null && widget.userData!.name != null) {
      nameTextCtrl.text = widget.userData!.name.toString();
    }
    if(widget.userData != null && widget.userData!.email != null) {
      emailTextCtrl.text = widget.userData!.email.toString();
    }
    if(widget.userData != null && widget.userData!.phone != null) {
      numberTextCtrl.text = widget.userData!.phone.toString();
    }
    if(widget.userData != null && widget.userData!.profilePic != null){
      uploadImageFile = await urlToFile(widget.userData!.profilePic.toString());
      sendImage = base64Encode(uploadImageFile!.readAsBytesSync());
    }
    setState(() {
     _value = widget.userData!.city.toString();
    });
  }
          ...
          child: Container(
            ...
            children: [
              Text(_value.toString(),style: TextStyle(
                  color: _value=='Your City' ? Colors.grey :Colors.black, fontWeight: FontWeight.bold,
